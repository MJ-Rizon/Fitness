...
async function enrollFingerprint() {
    try {
        ...
        // Check for prefix and timestamp
        ...
        if (match) {
            ...
            if (diff > 120 || diff < -10) { // more than 2 minutes old or in the future
...
<div class="container mt-5">
    ...
    <form method="post">
        ...
        <div class="mb-3">
            ...
            <a href="javascript:window.open('C:/Path/To/FingerprintEnroll.exe <?php echo $user_id; ?>')" class="btn btn-success">Enroll Fingerprint</a>
